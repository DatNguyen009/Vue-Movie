...
export default {
  ...
  created() {
    axios.get(`https://movie0706.cybersoft.edu.vn/api/QuanLyPhim/LayDanhSachPhimPhanTrang?maNhom=GP01&soTrang=${this.currentPage}&soPhanTuTrenTrang=${this.elementPage}`,{
  ...
  methods: {
    handleCurrentChange(val){
      axios.get(`https://movie0706.cybersoft.edu.vn/api/QuanLyPhim/LayDanhSachPhimPhanTrang?maNhom=GP01&soTrang=${val}&soPhanTuTrenTrang=${this.elementPage}`)
      .then(res => {
          this.listFilm = res.data;
      })
      .catch()
